<template>
    <header>
        ...
        <div class="mobile-menu-icon" @click="showMobileMenu"></div>
    </header>
    <div id="mobile-menu">
        <nav>
            <a href="#">Home</a>
    ...
    <main>
        <section id="home">
            ...
            <p>Velit, odio bibendum eu, viverra sit laoreet posuere. Ut scelerisque posuere massa amet.<br> Ornare
                lacinia
                vitae
                at vestibulum morbi. Volutpat libero curabitur feugiat risus dui pulvinar. Elementum.</p>
            <button>Let’s sell</button>
            <div class="brands">
                <img src="../assets/Zeus-NFT/images/brands/brand1.png" alt="Brand 1">
                <img src="../assets/Zeus-NFT/images/brands/brand2.png" alt="Brand 2">
                <img src="../assets/Zeus-NFT/images/brands/brand3.png" alt="Brand 3">
                <img src="../assets/Zeus-NFT/images/brands/brand4.png" alt="Brand 4">
                <img src="../assets/Zeus-NFT/images/brands/brand5.png" alt="Brand 5">
                <img src="../assets/Zeus-NFT/images/brands/brand6.png" alt="Brand 6">
            </div>
        </section>
        <section id="collection">
            <h2>Hottest Collections</h2>
            <p>Risus commodo id odio turpis pharetra elementum. Pulvinar porta porta feugiat scelerisque in elit.<br>
                Morbi
        ...
        <section id="services">
            ...
            <div class="services">
                ...
                <div class="service">
                    ...
                    <h4>Secure wallet</h4>
                    <p>Sed faucibus faucibus egestas volutpat, accumsan adipiscing egestas est. Auctor et leo urna
                        est.</p>
                </div>
                <div class="service">
        ...
        <section id="faq">
            <div class="title">
                ...
                <p>Risus commodo id odio turpis pharetra elementum.<br> Pulvinar porta porta feugiat scelerisque in
                    elit.<br>
                    Morbi
                    rhoncus, tellus, eros consequat magna semper orci a tincidunt. </p>
            </div>
...
@import '@/assets/Zeus-NFT/style.scss';
</style>

<style>
@import url(https://fonts.bunny.net/css?family=space-grotesk:400,500|syne:400,500,600,700);
